...
function fetchBooks() {
    fetch(apiURL) // Gör ett HTTP GET-anrop till API:et
        ...
        .then((data) => {
            ...
            if (!Array.isArray(data)) {
                ...
                booksContainer.innerHTML =
                    '<p class="text-danger">Oväntat dataformat från API:et.</p>'; // Visa felmeddelande på sidan
        ...
        .catch((error) => {
            ...
            booksContainer.innerHTML =
                '<p class="text-danger">Kunde inte ladda böcker.</p>'; // Visa felmeddelande på sidan
        });
}
...
function createBookCard(book) {
    ...
    const coverImage =
        book.cover || 'https://via.placeholder.com/300x400?text=Ingen+Bild'; // Placeholder-bild om cover saknas
...
function showBookDetails(bookNumber) {
    ...
    modalCover.src =
        book.cover || 'https://via.placeholder.com/300x400?text=Ingen+Bild'; // Sätt bokomslagsbilden
...
function applyFilters() {
    ...
    filteredBooks = allBooks.filter((book) => {
        ...
        const matchesYear = selectedYear
            ...
            : true; // Kontrollera om boken matchar valt år
